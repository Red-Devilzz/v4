...
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/Red-Devilzz/v4/main/Sshws/dropbear-ws.py
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/Red-Devilzz/v4/main/Sshws/ws-stunnel
...
wget -O /etc/systemd/system/ws-dropbear.service https://raw.githubusercontent.com/Red-Devilzz/v4/main/Sshws/service-wsdropbear && chmod +x /etc/systemd/system/ws-dropbear.service

#System SSL/TLS Websocket-SSH Python
wget -O /etc/systemd/system/ws-stunnel.service https://raw.githubusercontent.com/Red-Devilzz/v4/main/Sshws/ws-stunnel.service && chmod +x /etc/systemd/system/ws-stunnel.service
